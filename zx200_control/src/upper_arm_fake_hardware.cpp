...
{
hardware_interface::CallbackReturn Zx200UpperArmFakeHardware::on_init(const hardware_interface::HardwareInfo& info)
{
  ...
  imu_js_sub_ = node_->create_subscription<sensor_msgs::msg::JointState>(
      "/zx200/com3_ros/joint_states", 100, [this](sensor_msgs::msg::JointState msg) { imu_js_callback(msg); });
  ...
  for (const hardware_interface::ComponentInfo& joint : info_.joints)
  {
    ...
    {
      RCLCPP_FATAL(rclcpp::get_logger("Zx200UpperArmFakeHardware"),
    ...
    {
      RCLCPP_FATAL(rclcpp::get_logger("Zx200UpperArmFakeHardware"), "Joint '%s' has %zu state interface. 2 expected.",
...
Zx200UpperArmFakeHardware::on_configure(const rclcpp_lifecycle::State& /*previous_state*/)
{
...
std::vector<hardware_interface::StateInterface> Zx200UpperArmFakeHardware::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> Zx200UpperArmFakeHardware::export_command_interfaces()
{
...
hardware_interface::CallbackReturn
Zx200UpperArmFakeHardware::on_activate(const rclcpp_lifecycle::State& /*previous_state*/)
{
...
hardware_interface::CallbackReturn
Zx200UpperArmFakeHardware::on_deactivate(const rclcpp_lifecycle::State& /*previous_state*/)
{
  return hardware_interface::CallbackReturn::SUCCESS;
}

hardware_interface::return_type Zx200UpperArmFakeHardware::read(const rclcpp::Time& /*time*/,
...
hardware_interface::return_type Zx200UpperArmFakeHardware::write(const rclcpp::Time& /*time*/,
                                                                 const rclcpp::Duration& /*period*/)
{
  // Send command
...
PLUGINLIB_EXPORT_CLASS(zx200_control::Zx200UpperArmFakeHardware, hardware_interface::SystemInterface)
