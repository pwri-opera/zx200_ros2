#ifndef UPPER_ARM_VELOCITY_CONTROLLER_HPP_
#define UPPER_ARM_VELOCITY_CONTROLLER_HPP_
...
{
    class Zx200UpperArmVelocityHardware : public hardware_interface::SystemInterface
    {
        public:
            RCLCPP_SHARED_PTR_DEFINITIONS(Zx200UpperArmVelocityHardware)
