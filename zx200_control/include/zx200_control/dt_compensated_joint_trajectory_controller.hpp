...
#ifndef DT_COMPENSATED_JOINT_TRAJECTORY_CONTROLLER_HPP_
#define DT_COMPENSATED_JOINT_TRAJECTORY_CONTROLLER_HPP_
...
namespace dt_compensated_joint_trajectory_controller
{
class Trajectory;

class DTCompensatedJointTrajectoryController : public controller_interface::ControllerInterface
{
public:
  JOINT_TRAJECTORY_CONTROLLER_PUBLIC
  DTCompensatedJointTrajectoryController();
...
protected:
  // To reduce number of variables and to make the code shorter the interfaces are ordered . types
...
#endif  // DT_COMPENSATED_JOINT_TRAJECTORY_CONTROLLER_HPP_